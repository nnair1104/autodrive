...
sys.path.insert(0,'/home/freicar/freicar_ws/src/freicar_ss21_exercises/02-01-object-detection-exercise/')
...
weights_path = 'logs/freicar-detection/efficientdet-d0_99_109100.pth'
import os, sys
here = os.path.dirname(os.path.abspath('/home/freicar/freicar_ws/src/freicar_ss21_exercises/02-01-object-detection-exercise/projects/'))
